...
public enum ErrorCode {
    ...
    EXPANSION_NOT_APPROVED(HttpStatus.CONFLICT, "Expansion is not approved"),
    EXPANSION_NOT_EDITABLE(HttpStatus.CONFLICT, "Expansion cannot be modified in its current moderation status"),
    EXPANSION_NOT_PENDING(HttpStatus.CONFLICT, "Expansion is not pending moderation"),
    EXPANSION_NOT_REJECTED(HttpStatus.CONFLICT, "Expansion is not rejected"),
    GAME_HAS_EXPANSIONS(HttpStatus.CONFLICT, "Game cannot be deleted while expansions reference it"),
