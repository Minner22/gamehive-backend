...
public record AuditLogResponseDto(
        @Schema(description = "Identyfikator wpisu.", example = "1024", requiredMode = Schema.RequiredMode.REQUIRED)
        Long id,
        ...
        String details,
        @Schema(description = "Identyfikator korelacji powiązany z logami żądania; może być puste dla zdarzeń spoza kontekstu żądania HTTP.",
