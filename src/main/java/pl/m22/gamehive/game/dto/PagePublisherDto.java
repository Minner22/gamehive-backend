...
public record PagePublisherDto(
        ...
        int size,
        @Schema(description = "Łączna liczba elementów.", example = "412", requiredMode = Schema.RequiredMode.REQUIRED)
        long totalElements,
        @Schema(description = "Łączna liczba stron.", example = "21", requiredMode = Schema.RequiredMode.REQUIRED)
        int totalPages,
