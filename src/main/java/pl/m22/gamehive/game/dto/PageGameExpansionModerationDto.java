...
/**
 * Schemat dokumentacyjny stronicowanej kolejki moderacji dodatków.
 ...
 */
@Schema(description = "Stronicowana lista dodatków w widoku moderacji.")
public record PageGameExpansionModerationDto(

        @Schema(description = "Zawartość bieżącej strony.", requiredMode = Schema.RequiredMode.REQUIRED)
        List<GameExpansionModerationDto> content,
