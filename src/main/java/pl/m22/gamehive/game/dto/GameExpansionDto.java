...
/**
 * Dodatek w widoku użytkownika. Każde nadpisywalne pole występuje w dwóch wariantach: własnym
 * (null/pusty = dziedziczone) i efektywnym (własne albo wartość gry bazowej) — front dzięki temu
 * odróżnia nadpisanie od dziedziczenia bez pobierania gry bazowej.
 */
@Schema(description = "Dodatek / zgłoszenie dodatku ze statusem moderacji, wartościami własnymi i efektywnymi.")
