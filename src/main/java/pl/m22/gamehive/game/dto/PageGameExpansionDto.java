...
/**
 * Schemat dokumentacyjny stronicowanej odpowiedzi z dodatkami.
 * Odwzorowuje płaski JSON {@code PageImpl} z wymaganymi polami — nie jest serializowany,
 * służy wyłącznie do wygenerowania kontraktu OpenAPI (zastępuje słaby auto-schemat {@code Page<GameExpansionDto>}).
 */
@Schema(description = "Stronicowana lista dodatków.")
public record PageGameExpansionDto(
