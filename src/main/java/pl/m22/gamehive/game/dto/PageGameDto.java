...
/**
 * Schemat dokumentacyjny stronicowanej odpowiedzi ze zgłoszeniami gier.
 * Odwzorowuje płaski JSON {@code PageImpl} z wymaganymi polami — nie jest serializowany,
 * służy wyłącznie do wygenerowania kontraktu OpenAPI (zastępuje słaby auto-schemat {@code Page<GameDto>}).
 */
@Schema(description = "Stronicowana lista zgłoszeń gier.")
